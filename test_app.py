...
def test_hello_route():
    """Teste si la route '/' retourne un code 200 OK et contient 'Hello World'."""
    ...
    assert b"Hello World" in response.data # Vérifier que la réponse contient le texte attendu (b"" pour bytes)